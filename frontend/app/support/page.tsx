...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'הקמת הקהילה מגיעה עם 14 ימי ניסיון בחינם, ללא כל התחייבות, כדי שתוכלו להתרשם מכל הכלים. לאחר מכן, עלות התחזוקה היא 99 ש״ח בחודש, לצד עמלת סליקה של 5% בלבד על עסקאות שמבוצעות דרך הפלטפורמה.',
  },
  {
