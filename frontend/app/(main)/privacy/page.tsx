      ...
      <section className="max-w-4xl mx-auto px-4 pb-8">
        <div className="bg-white rounded-2xl shadow-sm p-8" style={{ border: '1px solid #E1E1E2' }}>
          ...
          <div className="space-y-4 leading-relaxed" style={{ color: '#52525B' }}>
            ...
            <p>
              הפלטפורמה מופעלת על ידי <strong>תומר שמחון ברעם</strong>, עוסק פטור שמספרו <strong>323115600</strong>. בעצם השימוש בשירותי הפלטפורמה, ניתנת הסכמתך לאיסוף ולשימוש במידע בהתאם למדיניות זו.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-8" style={{ border: '1px solid #E1E1E2' }}>
          ...
          <div className="space-y-6 leading-relaxed" style={{ color: '#52525B' }}>
            <div>
              ...
              <p>
                בעת ההרשמה, אנו אוספים את השם המלא וכתובת הדוא"ל שלך. בנוסף, באפשרותך להוסיף תמונת פרופיל, ביוגרפיה, ותמונת רקע. כמו כן, התוכן המפורסם על ידך בפלטפורמה (פוסטים, תגובות, קורסים) נשמר כחלק משירותי הפלטפורמה.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                איננו משתמשים בכלי אנליטיקס חיצוניים או בכלי מעקב למטרות פרסום או פרופיילינג של משתמשים (כגון Google Analytics וכדומה). אנו משתמשים בטכנולוגיות שמירה מקומיות (Cookies ו-Local Storage) למטרה טכנית הכרחית אחת: לשמור על החשבון מחובר (Logged in) למשך 30 ימים, ולשמור העדפות פונקציונליות (כגון מצב תצוגה).
              </p>
            </div>
            <div>
            ...
            <div>
              <h3 className="font-semibold text-black mb-2">1.5. מידע פיננסי וזיהוי של יוצרי קהילות</h3>
              <p>
                עבור משתמשים הבוחרים לפתוח קהילות בתשלום ולייצר הכנסה דרך הפלטפורמה, אנו אוספים ושומרים את פרטי חשבון הבנק (שם בעל החשבון, שם הבנק, מספר חשבון, מספר סניף) וכן מספר זיהוי ממשלתי (ת.ז. או ח.פ./ע.מ.). מידע זה נאסף ונשמר אך ורק למטרות העברת תשלומי ההכנסות החודשיים המגיעים ליוצר, ניהול ספרי חשבונות של החברה, ועמידה בדרישות הרגולציה ורשויות המס בישראל (כגון חובות זיהוי וניכוי מס במקור). מידע זה נשמר בצורה מאובטחת במאגרי המידע שלנו ומועבר אך ורק לגורמים המורשים (כגון הנהלת החשבונות של החברה והבנק המבצע את ההעברות) לצורך ביצוע התשלום והתיעוד החוקי.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-8">
        <div className="bg-white rounded-2xl shadow-sm p-8" style={{ border: '1px solid #E1E1E2' }}>
          ...
          <div className="space-y-4 leading-relaxed" style={{ color: '#52525B' }}>
            ...
            <p>
              <strong>שמירת מידע:</strong> אנו שומרים את המידע שלך כל עוד החשבון פעיל. לאחר מחיקת החשבון, המידע יימחק תוך 30 יום, למעט מידע שאנו מחויבים לשמור על פי חוק. לתשומת ליבך — מידע פיננסי ורשומות חשבונאיות (כגון חשבוניות ונתוני תשלומים) חייבים להישמר למשך 7 שנים בהתאם להוראות מס הכנסה ותקנות מס ערך מוסף.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-8">
        <div className="bg-white rounded-2xl shadow-sm p-8" style={{ border: '1px solid #E1E1E2' }}>
          ...
          <div className="space-y-4 leading-relaxed" style={{ color: '#52525B' }}>
            ...
            <ul className="list-disc list-inside space-y-2 mr-4">
              <li><strong>גישה לעיון:</strong> לבקש לעיין במידע האישי שאנו מחזיקים עליך.</li>
              <li><strong>תיקון או מחיקה:</strong> לדרוש תיקון או מחיקה של מידע שגוי, לא שלם, לא ברור או לא מעודכן.</li>
            </ul>
            <p>
